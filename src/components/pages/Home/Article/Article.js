    ...
    <div>
      <article className="max-w-2xl px-6 py-24 mx-auto space-y-12 dark:bg-gray-800 dark:text-gray-50">
        <div className="w-full mx-auto space-y-4 text-center">
          <p className="text-lg text-cyan-600 border-b-2 border-cyan-500 font-semibold tracking-wider uppercase">
            PHYSIOTHERAPY.
          </p>
          <h1 className="text-4xl font-bold leading-tight md:text-5xl">
            Physiotherapy is a science-based profession and takes a ‘whole
            person’ approach to health and wellbeing,
          </h1>
